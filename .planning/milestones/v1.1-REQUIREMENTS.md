...
- [x] **IMP-02**: Import shows a confirmation before overwriting existing data

### resume.json Themes

- [x] **THM-01**: User can select from bundled resume.json themes for preview and export
- [x] **THM-02**: Theme-rendered preview shows in the Preview sub-tab
- [x] **THM-03**: PDF export uses the selected theme's HTML rendering
