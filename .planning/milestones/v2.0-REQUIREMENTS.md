# Requirements Archive: v2.0 AI Analysis Integration
...
- [x] **AI-01**: User can select an AI provider (Claude, OpenAI) from a settings page
- [x] **AI-02**: User can enter and save their API key with masked display
- [x] **AI-03**: API keys are stored using OS-level encryption (Electron safeStorage) and never exposed to the renderer process
- [x] **AI-04**: User can test their API key connection and see success/failure feedback
